...
var http_1 = require("@angular/http"); //p27.1
var router_1 = require("@angular/router"); //p30.3.1
var app_component_1 = require("./app.component");
var employee_component_1 = require("./employee/employee.component"); //p6
...
var userPreferences_1 = require("./employee/userPreferences"); //p34.3.1
var appRoutes = [
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            providers: [employee_service_1.EmployeeService, userPreferences_1.UserPreferencesService] //p31.6.2
        })
    ], AppModule);
    return AppModule;
}());
